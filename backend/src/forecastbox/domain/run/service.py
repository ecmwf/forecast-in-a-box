...
def submit_run_sync(
    ...
    Inserts a Run row and enqueues compilation and cascade submission onto
    the RunSubmission pool so this call can quickly return the ExecuteResult.
    When ``run_id`` is supplied the new attempt is appended under
