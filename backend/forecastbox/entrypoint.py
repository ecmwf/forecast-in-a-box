...
async def share_image(request: Request, job_id: str, dataset_id: str):
    ...
    # TODO: Consider better way to bypass auth for shared images, we may want to lock it to certain users, or only share certain images, so come key passing may be needed.
