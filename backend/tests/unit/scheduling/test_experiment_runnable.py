...
@patch("forecastbox.domain.experiment.scheduling.job_utils.experiment_db.get_experiment_definition")
@patch("forecastbox.domain.experiment.scheduling.job_utils.blueprint_db.get_blueprint")
