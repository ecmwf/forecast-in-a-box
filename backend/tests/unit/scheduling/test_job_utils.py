...
def test_eval_dynamic_expression_single_replacement() -> None:
...
def test_eval_dynamic_expression_nested_replacement() -> None:
...
def test_eval_dynamic_expression_multiple_replacements() -> None:
...
def test_eval_dynamic_expression_partial_match() -> None:
